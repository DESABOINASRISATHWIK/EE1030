...
\begin{tikzpicture}
    ...
    % Force vector
    \draw[thick, ->] (5.5,-1) -- (5.5,-2) node[midway,right] {100 N}; % Downward force arrow
    ...
    % Dimension lines
    % Full length
    \draw[<->] (0,-2) -- (10,-2) node[midway, below] {1000 mm}; 
    ...
    \draw[<->] (5,-2.5) -- (6,-2.5) node[midway, below] {100 mm};
    
    % Vertical drop
    \draw[<->] (6,-1) -- (6,-3) node[midway, right] {100 mm};
\end{tikzpicture}
\end{document}
